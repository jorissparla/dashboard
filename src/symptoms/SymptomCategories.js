...
const SymptomCategories = () => {
  ...
  return (
    <div className="h-screen  max-w-full bg-gray-50">
        ...
        {data?.categories?.length > 0 ? (
          <>
            <TWSelectMenu
              ...
              wide
            />
            <div className="ml-5  flex p-2 bg-white overflow-hidden shadow rounded-lg w-48">
              <dl>
                <dt className="text-sm leading-5 font-medium text-gray-500 truncate">Total Symptoms</dt>
                <dd className="flex items-baseline">
                  <div className="text-2xl leading-8 font-semibold text-gray-900">{data.symptoms.length}</div>
                </dd>
              </dl>
            </div>
            <div className="ml-5 w-96 flex p-2 bg-white overflow-hidden shadow rounded-lg">
              <dl>
                <dt className="text-sm leading-5 font-medium text-gray-500 truncate">Last Updated </dt>
                <dd className="flex items-baseline">
                  <div className="text-2xl leading-8 font-semibold text-gray-900">{format(data.symptoms[0].date, "EEE dd MMM yyyy, HH:mm")}</div>
                </dd>
              </dl>
            </div>
          </>
          ...
          <div className="rounded-md bg-yellow-50 p-4 w-1/2">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm leading-5 font-medium text-yellow-800">No data seems to be loaded</h3>
                <div className="mt-2 text-sm leading-5 text-yellow-700 font-semibold">
