...
class AccountFilter extends Component {
  ...
  toggleGuest = () => {
    ...
    this.state.firstname === "Guest" ? this.setState({ firstname: "" }) : this.setState({ firstname: "Guest" });
  };
            ...
            {({ data, loading }) => {
              ...
              return (
                <div className="container">
                  ...
                  <FormControlLabel
                    control={<Checkbox value="Guest" onChange={this.toggleGuest} checked={this.state.firstname === "Guest"} />}
                  ...
                  <div className="container">
                    ...
                    {this.state.location}
                    {this.state.region}
                    <Button variant="outlined" color="primary" className={classes.button} onClick={() => this.props.onApply(this.makeFilter())}>
                      Apply Filter
                    </Button>
                    <Button variant="outlined" color="secondary" className={classes.button} onClick={this.clearFilter}>
                      Clear Filter
                    </Button>
                  </div>
                </div>
