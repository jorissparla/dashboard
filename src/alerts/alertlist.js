            ...
            return (
                <li className="collection-item App-align" key={ item.id }>
                  <div className="row">
                    ...
                    <div className="right">
                      <Link to={ "/alerts/" + item.id } className="btn-floating btn-small right waves-effect waves-light blue">
        ...
        return (
            <div>
              ...
              <div className="fixed-action-button">
                <Link to={ "/alerts/new" } className="btn-floating btn-large waves-effect waves-light orange ">
