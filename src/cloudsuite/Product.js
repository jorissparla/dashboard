...
function Product({ match, history }) {
  ...
  return <ProductForm product={data.cloudsuiteproduct} history={history} classes={classes}></ProductForm>;
}

export default withRouter(Product);

const ProductForm = (props) => {
  const { product, onSave = () => console.log("dave"), authenticated = true, onDelete = () => console.log("delke"), history, classes } = props;
          ...
          return (
            <form onSubmit={handleSubmit}>
              ...
              <CardSection>
                ...
                {!readOnly && product && (
                  <Button variant="contained" color="primary" className={classes.buttonDel} onClick={() => onDelete()}>
                    Delete
                  </Button>
                )}
                <Button
