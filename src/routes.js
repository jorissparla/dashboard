...
function AppRoutes(props) {
  ...
  return (
    <Switch>
      <AuthRoute exact path="/statsmain" component={StatsMain} user={user} history={props.history} />
      ...
      <AuthRoute allowed={["Admin", "PO", "SU", "Guest", "Chat"]} user={user} exact path="/test" component={TestUser} />
      <EnhancedRoute
        editors={["Admin", "PO", "SU"]}
        user={user}
        exact
