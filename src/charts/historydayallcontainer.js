...
class HistoryDayAll extends Component {
  ...
  render () {
    ...
    return (
      <Flexdiv> 
      <Contdiv>
        <HistoryChart data={history} title={`Backlog LN`} type='area' color={color} xvalue='day'  value={`LN`} />
        <HistoryChart data={history} title={`Backlog Logistics`} type='area' color={color} xvalue='day'  value={`Logistics`} />
      </Contdiv>
      <Contdiv>
        <HistoryChart data={history} title={`Backlog Finance`} type='area' color={color} xvalue='day'  value={`Finance`} />

        <HistoryChart data={history} title={`Backlog Tools`} type='area' color={color} xvalue='day'  value={`Tools`} />
      </Contdiv>
      </Flexdiv>
    )
  }
