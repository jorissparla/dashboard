...
import NewsCard from './newscard0'
import Spinner from '../utils/spinner'

class NewsCardContainer0 extends Component {
...
export default connect(mapStateToProps, {fetchNews})(NewsCardContainer0)
